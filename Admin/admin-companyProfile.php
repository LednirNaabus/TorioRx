...
<html>
    ...
    <body>
		...
		<center>
			<div class="container" style="margin-top:-10.6vh; font-family: 'Cutive Mono'; font-size: 35px; ">
			  <div class="row">
				<div class="col" style="background-color:rgba(25, 144, 206, 0.92); color: white; padding-top:2vh; padding-bottom:2vh;">
				  <a href="#announcements" style="color: white; text-decoration: none;">ANNOUNCEMENTS</a>
				</div>
			...
			<div id = "announcements"  class="container-fluid" style="padding-bottom: 10vh;">
				<b><p style="font-family: Arial,Helvetica,sans-serif; font-size: 60px; color:#1990ce; z-index:1; padding-top: 10vh;">ANNOUNCEMENTS</p></b>
				<div class="container-fluid" style="background-color:#1990ce; width:1vw; height:2.5vh;">
					<p> &nbsp;</p>
				</div>
				<div id = "feedbacks" class="container-fluid">
					<div class="container-fluid list-group" style="margin-top:10vh;">
						 <a class="list-group-item list-group-item-action" aria-current="true">
							<div class="d-flex w-100 justify-content-between">
							  ...
							  <button type="button" style="float: right;" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">
								...
								<button type="button" style="float: right; margin-left:-74vw;" class="btn btn-primary">
									<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
									  <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 
										8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z"/>
									</svg>
								</button>
							</div>
					...
					<button type="button" class="btn btn-outline-primary" style="margin-top:7vh;">Add Announcement</button>
				</div>
			</div>
			...
			<div id = "aboutUs" class="container-fluid background" style = "padding-bottom:15vh; padding-top:10vh;">
				...
				<div class="container-fluid" style="padding-bottom: 10vh;">
