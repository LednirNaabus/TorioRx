...
<html>
    ...
    <body>
		...
		<div id = "ourMedicines" class="container-fluid background">
				<b><p style="font-size: 60px; color:white; z-index:1; padding-top: 10vh;">CONTACT US</p></b>
				<div class="container-fluid" style="background-color:white; width:1vw; height:2.5vh;">
					<p> &nbsp;</p>
				</div>
					
				<p style="color: white; margin-top: 8vh; font-size: 20px;">Whether you have a question, complaints, or anything else, our team is ready to respond.</p>
		</div>
		</center>
					  ...
					  <div class="row">
						<div class="col" >
							...
							<i class="fa fa-phone" style="font-size:25px; color:#1990ce; display:flex;">
								<b>
									<p style="color: #1990ce; font-size: 25px;">&nbsp;&nbsp;For Inquiries:</p>
								</b>
							</i>
								<br>
								
							<p style="color: #999999; font-size: 17px;">Location: 052 P. Burgos St, Brgy. Lunsad, Binangonan, 1940 Rizal</p>
								
							<p style="color: #999999; font-size: 17px;">Email: TorioRx@gmail.com</p>
							...
							<i class="fa fa-clock-o" style="font-size:25px; color:#1990ce; display:flex;">
								<b>
									<p style="color: #1990ce; font-size: 25px;">&nbsp;&nbsp;Opening Hours</p>
								</b>
							</i>
								<br>
						...
						<div class="col" style="color: grey; padding-left:5vh; border: ">
							<center>
								<form style="box-shadow: 0 0 15px; padding: 50px; border-radius: 5px;" action="post_feedback.php" method="post">
								  <b><p style="color: #09407c; font-size: 45px;">Get in touch with us!</p></b>
								
								<br>

									<div class="form-floating" style="font-size: 15px;width:25vw;">
								...
								<br>
								  <button type="submit" class="btn btn-primary" style="font-size: 18px;width:25vw; color:white; background-color: #09407c;">Send Message</button>
